...
const MOCK_USERS = {
    'admin@wewill.com.au': {
        id: '1',
        email: 'admin@wewill.com.au',
        name: 'Admin User',
        role: 'admin'
    },
    'ops@wewill.com.au': {
        id: '2',
        email: 'ops@wewill.com.au',
        name: 'Operations Staff',
        role: 'operationsstaff'
    },
    'it@wewill.com.au': {
        id: '3',
        email: 'it@wewill.com.au',
        name: 'IT Team',
        role: 'itteam'
    }
};
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const storedUser = localStorage.getItem('wewill_user');
        if (storedUser) {
    ...
    const login = async (email, password)=>{
        ...
        setUser(user);
        localStorage.setItem('wewill_user', JSON.stringify(user));
    };
    const logout = ()=>{
        setUser(null);
        localStorage.removeItem('wewill_user');
    };
